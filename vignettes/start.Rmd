...
| Distribution Type         | option_name (char) | sum_impressions (int) | sum_clicks (int) | sum_sessions (int) | sum_conversions (dbl) | sum_revenue (dbl) | sum_cost (dbl) | sum_sessions_2 (int) | sum_conversions_2 (dbl) | sum_revenue_2 (dbl) |
|---------------------------|:------------------:|:---------------------:|:----------------:|:------------------:|:---------------------:|:-----------------:|:--------------:|:--------------------:|:-----------------------:|:-------------------:|
| Conversion Rate           |          X         |                       |         X        |                    |           X           |                   |                |                      |                         |                     |
| Response Rate             |          X         |                       |                  |          X         |           X           |                   |                |                      |                         |                     |
| Multi Response Rate       |          X         |                       |                  |          X         |           X           |                   |                |           X          |             X           |                     |
| Click Through Rate (CTR)  |          X         |           X           |         X        |                    |                       |                   |                |                      |                         |                     |
| Revenue Per Session       |          X         |                       |                  |          X         |           X           |         X         |                |                      |                         |                     |
| Multi Revenue Per Session |          X         |                       |                  |          X         |           X           |         X         |                |           X          |             X           |           X         |
